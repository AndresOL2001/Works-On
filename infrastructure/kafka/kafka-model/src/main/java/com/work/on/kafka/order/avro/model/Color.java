...
public class Color extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   * @param hex The new value for hex
   */
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: hex = value$ != null ? value$.toString() : null; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }

  /**
   * Gets the value of the 'hex' field.
   * @return The value of the 'hex' field.
   */
  ...
  /**
   * Sets the value of the 'hex' field.
   * @param value the value to set.
   */
  public void setHex(java.lang.String value) {
    this.hex = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Color>
    ...
    /**
      * Checks whether the 'hex' field has been set.
      * @return True if the 'hex' field has been set, false otherwise.
      */
    ...
    public Color build() {
      try {
        ...
        record.hex = fieldSetFlags()[0] ? this.hex : (java.lang.String) defaultValue(fields()[0]);
        return record;
